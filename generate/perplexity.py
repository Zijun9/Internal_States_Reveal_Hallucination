...
class Perplexity(evaluate.Metric):
    def __init__(self, *args, **kwargs):
        ...
        if os.path.isdir("/share/jiziwei/Llama-2-7b-chat-hf"): #116
        ...
        elif os.path.isdir("/cpfs01/shared/public/public_hdd/llmeval/model_weights/hf_hub/models--meta-llama--Llama-2-7b-chat-hf/snapshots/c1b0db933684edbfe29a06fa47eb19cc48025e93"): #ali
            ...
            model_path = "/scratch/emllmerobo/Llama-2-7b-chat-hf" #superpod
    ...
    def _compute(
        self, predictions, batch_size: int = 16, add_start_token: bool = True, device=None, max_length=None
    ):
        device = self.device
        model = self.model
